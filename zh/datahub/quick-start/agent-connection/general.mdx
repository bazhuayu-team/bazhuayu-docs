...
<Note>
  需要查看 `search_data_apps`、`run_data_app`、异步状态查询和大结果 `handoff` 的完整参数与处理规则时，参阅 <a href="/zh/datahub/mcp-capabilities" target="_blank" rel="noopener noreferrer">DataHub MCP 能力说明</a>。本篇仍专注于连接与首次使用流程。
</Note>
