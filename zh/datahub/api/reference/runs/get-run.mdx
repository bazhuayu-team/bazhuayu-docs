---
title: "查询运行"
description: "读取一次运行的状态、进度、错误、用量与费用，支持长轮询。"
api: GET https://api-datahub.bazhuayu.com/v1/runs/{run_id}
authMethod: bearer
---
...
字段与<a href="/zh/datahub/api/reference/runs/start-run" target="_blank" rel="noopener noreferrer">发起运行</a>的返回相同。
