...
api: GET https://api-datahub.bazhuayu.com/v1/data-apps/manifest-schema
authMethod: none
---
...
供编辑器、编码助手和第三方校验器使用。对错判定唯一以 <a href="/zh/datahub/api/reference/publishing/validate-manifest" target="_blank" rel="noopener noreferrer">校验 manifest</a> 的返回为准。
