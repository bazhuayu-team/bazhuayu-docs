...
api: GET https://api-datahub.bazhuayu.com/v1/publisher/runs/{run_id}
authMethod: bearer
---
...
字段与<a href="/zh/datahub/api/reference/publishing/list-publisher-runs" target="_blank" rel="noopener noreferrer">发布者运行列表</a>的条目相同，外加 `warnings[]`。
