...
API Key 在八爪鱼账户中心创建，步骤见 <a href="/zh/mcp/quick-start/api-key" target="_blank" rel="noopener noreferrer">获取 API Key</a>。详细约定见 <a href="/zh/datahub/api/reference/introduction" target="_blank" rel="noopener noreferrer">通用约定</a>。
...
<Tabs>
  <Tab title="Python">
    ...
    <a href="/zh/datahub/api/clients/python" target="_blank" rel="noopener noreferrer">Python 客户端库文档</a>
  </Tab>
  ...
  <Tab title="JavaScript">
    ...
    <a href="/zh/datahub/api/clients/javascript" target="_blank" rel="noopener noreferrer">JavaScript 客户端库文档</a>
  </Tab>
</Tabs>

## MCP

让 Agent 直接使用 Data App 时，接入 DataHub 通用 MCP 即可，不需要写代码。它提供搜索、详情、运行、状态、结果、取消、列表七个工具，并可把指定 App 钉选为专用工具。见<a href="/zh/datahub/mcp-capabilities" target="_blank" rel="noopener noreferrer">DataHub MCP 能力说明</a>与<a href="/zh/datahub/quick-start/agent-connection/general" target="_blank" rel="noopener noreferrer">通用连接教程</a>。
