---
title: 批量停止子任务
description: "介绍“批量停止子任务”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/cloudextraction/subtasks:stop
...
```
POST https://openapi.bazhuayu.com/cloudextraction/subtasks:stop
```
...
<ParamField body="subTaskIds" type="string[]" required hidden>
</ParamField>
