---
title: 获取子任务状态
description: "介绍“获取子任务状态”接口的功能、参数与调用方法。"
api: GET https://openapi.bazhuayu.com/cloudextraction/task/subtasks
...
```
GET https://openapi.bazhuayu.com/cloudextraction/task/subtasks?taskId=11d18cb2-6209-4b35-9243-c33a07be45b0&page=1&size=20
```
...
<ParamField query="page" type="number" required hidden>
</ParamField>
