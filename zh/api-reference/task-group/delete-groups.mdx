---
title: 批量删除任务组
description: "介绍“批量删除任务组”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/taskGroup/deleteGroups
...
```
POST https://openapi.bazhuayu.com/taskGroup/deleteGroups
```
