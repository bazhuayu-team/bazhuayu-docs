---
title: 查询任务采集与执行分析
description: "介绍“查询任务采集与执行分析”接口的功能、参数与调用方法。"
...
| 参数 | 类型 | 必填 | 说明 |
|------|------|------|------|
| `x-api-key` | String | 是 | API Key，例如 `op_sk_xxxxxx`；创建方式见<a href="/zh/mcp/quick-start/api-key" target="_blank" rel="noopener noreferrer">获取 API Key</a> |
