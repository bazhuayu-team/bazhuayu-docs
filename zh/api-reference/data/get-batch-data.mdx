...
description: "介绍“根据指定位置获取任务批次数据”接口的功能、参数与调用方法。"
api: GET https://openapi.bazhuayu.com/data/lotno/all
...
```
GET https://openapi.bazhuayu.com/data/lotno/all
```
...
```
GET https://openapi.bazhuayu.com/data/lotno/all?taskId=a3b9bdf7-9aaa-22f6-9ccf-b32790f6df8f&lotno=638590565765988670&offset=0&size=4
```
...
<ParamField query="lotno" type="string" required hidden>
</ParamField>
