---
title: 移动任务
description: "介绍“移动任务”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/task/moveToGroup
...
```
POST https://openapi.bazhuayu.com/task/moveToGroup?taskId={taskId}&taskGroupId={taskGroupId}
```
...
| 参数 | 类型 | 必填 | 说明 |
|------|------|------|------|
| `x-api-key` | String | 二选一 | API Key，例如 `op_sk_xxxxxx`；创建方式见 <a href="/zh/mcp/quick-start/api-key" target="_blank" rel="noopener noreferrer">获取 API Key</a> |
| `Authorization` | String | 二选一 | Access Token，格式 `Bearer <access_token>` |
...
| `taskGroupId` | int | 是 | 目标任务组Id |

**请求示例**

```
POST https://openapi.bazhuayu.com/task/moveToGroup?taskId=49676b13-cfed-44f4-8985-b978c98c4085&taskGroupId=2648037
```
...
<ParamField query="taskGroupId" type="number" required hidden>
</ParamField>
