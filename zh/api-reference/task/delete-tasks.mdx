---
title: 批量删除任务
description: "介绍“批量删除任务”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/task/deleteTasks
...
```
POST https://openapi.bazhuayu.com/task/deleteTasks
```
...
| 参数 | 类型 | 必填 | 说明 |
|------|------|------|------|
| `taskIds` | string[] | 是 | 需要删除的任务 Id 列表 |
