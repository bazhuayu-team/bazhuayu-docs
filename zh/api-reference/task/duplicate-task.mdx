---
title: 复制任务
description: "介绍“复制任务”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/task/copy
...
```
POST https://openapi.bazhuayu.com/task/copy?taskId={taskId}&taskGroupId={taskGroupId}
```
...
| `taskGroupId` | int | 否 | 任务组Id（不传则复制到当前任务的任务组） |

**请求示例**

```
POST https://openapi.bazhuayu.com/task/copy?taskId=a2de44e9-092c-453c-bfe3-fe9e71dff12345&taskGroupId=100
```
...
<ParamField query="taskGroupId" type="number" hidden>
</ParamField>
