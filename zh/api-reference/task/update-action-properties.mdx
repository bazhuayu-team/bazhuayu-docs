---
title: 更新步骤配置
description: "介绍“更新步骤配置”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/task/updateActionProperties
...
```
POST https://openapi.bazhuayu.com/task/updateActionProperties
```
...
| `actions` | Object[] | 是 | 需要更新的步骤参数（含 `actionType`、`actionId`、`properties`），参考：步骤属性 |
  ...
  "actions": [
    {
      ...
      "actionId": "1j4prvwsy1z",
      "properties": [
        {
          "name": "Url",
          "value": "https://www.bazhuayu.com"
        }
      ]
    }
  ]
