---
title: 批量获取任务步骤信息
description: "介绍“批量获取任务步骤信息”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/task/getActions
...
| `actionTypes` | String[] | 是 | 步骤类型列表，支持：LoopAction（循环列表）、NavigateAction（打开网页）、EnterTextAction（输入文本） |
...
<ParamField body="actionTypes" type="string[]" required hidden>
</ParamField>
