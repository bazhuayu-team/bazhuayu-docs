---
title: 获取全新 Token
description: "介绍“获取全新 Token”接口的功能、参数与调用方法。"
api: POST https://openapi.bazhuayu.com/token
...
<ParamField body="username" type="string" required hidden>
</ParamField>
<ParamField body="password" type="string" required hidden>
</ParamField>
<ParamField body="grant_type" type="string" default="password" initialValue="password" required hidden>
</ParamField>
