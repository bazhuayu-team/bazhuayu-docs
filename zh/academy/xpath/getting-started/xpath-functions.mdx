...
在八爪鱼中常用于数字翻页，点击查看 <a href="/zh/academy/basic-collection/pagination/number-pagination" target="_blank" rel="noopener noreferrer">数字翻页教程</a>。
...
1、按照 <a href="/zh/academy/basic-collection/beginner/list-collection" target="_blank" rel="noopener noreferrer">列表采集</a> 和 <a href="/zh/academy/basic-collection/pagination/next-page-button" target="_blank" rel="noopener noreferrer">翻页</a> 的方法，配置采集规则。
