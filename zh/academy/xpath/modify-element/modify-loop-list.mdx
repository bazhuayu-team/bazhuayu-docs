...
我们通过创建【循环列表】去采集多个列表或详情页的数据。创建【循环列表】的方式在 <a href="/zh/academy/basic-collection/beginner/custom-collection" target="_blank" rel="noopener noreferrer">初级采集</a>中有详细讲过。
...
实例网址：<a href="https://www.made-in-china.com/companysearch.do?word=led&file=&subaction=hunt&style=b&mode=and&code=0&comProvince=nolimit&order=0&isOpenCorrection=1" target="_blank" rel="noopener noreferrer">https://www.made-in-china.com/companysearch.do?word=led&file=&subaction=hunt&style=b&mode=and&code=0&comProvince=nolimit&order=0&isOpenCorrection=1</a>
...
如何修改需要一定的XPath知识，请看之前的 <a href="/zh/academy/xpath/getting-started/why-use-xpath" target="_blank" rel="noopener noreferrer">XPath系统学习教程</a> 。
