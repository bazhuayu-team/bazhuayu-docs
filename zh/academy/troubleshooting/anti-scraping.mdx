---
title: "常见防采集套路及解决方法"
description: "了解“常见防采集套路及解决方法”的排查方法与解决方案。"
---
...
**图文教程：**<a href="/zh/academy/basic-collection/beginner/login-verification" target="_blank" rel="noopener noreferrer">登录后再采集数据（含登录时有验证码）</a>

**视频教程：**<a href="http://www.bazhuayu.com:8099/tutorial8/81spdlyz" target="_blank" rel="noopener noreferrer">登录后再采集数据（含登录时有验证码）</a>
